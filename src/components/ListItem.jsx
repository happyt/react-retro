...
export default class ListItem extends PureComponent {
  render () {
    const { _id, i, name, description, picture, toggleModal, deleteItem } = this.props;
    return (
        ...
        <div className="thumbnail">
          ...
          <div className="caption">
            ...
            <div className="btn-group" role="group" aria-label="...">
              ...
              <button className="btn btn-danger" role="button" onClick={() => deleteItem(_id)}>Delete</button>
            </div>
          </div>
        </div>
      </div>
