...
This is a small test with bootstrap, jQuery 3, react to attach to a 
server api to list items and add/delete new ones. 
It has a function to upload an image.
No redux there yet - still in progress.

Comparison of redux-saga
[https://survivejs.com/blog/redux-saga-interview/](https://survivejs.com/blog/redux-saga-interview/)
